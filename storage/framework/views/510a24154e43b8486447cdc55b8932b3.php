                ...
                <div class="card-body">
                    ...
                    <tr>
                        ...
                        <td>
                          ...
                          <input name="judul" type="text" value="<?php echo e($data->judul); ?>" class="form-control" id="exampleInputEmail1" placeholder="Judul Berita">
                        </div>
                        </td>
                    </tr>
                    <tr>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Nommensen Internship\master_uhn\resources\views/pengumuman/edit.blade.php ENDPATH**/ ?>